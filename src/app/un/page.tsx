...
export default function UnsubscribePage() {
  ...
  const handleUnsubscribe = async () => {
    ...
    setLoading(true);
    try {
      await setDoc(doc(db, 'unsubscribed', email), {
        email,
  ...
  if (unsubscribed) {
    return (
      <div className="max-w-xl mx-auto mt-20 text-center">
        ...
        <p className="text-sm text-gray-500">If this was a mistake, contact us at <a href="mailto:info@masala-gf.shop" className="underline">info@masala-gf.shop</a>.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-xl mx-auto mt-20 p-6 text-center border rounded-lg shadow-sm bg-white">
      ...
      <div className="bg-yellow-100 p-4 rounded-md mb-6">
        ...
        <p className="text-sm text-gray-600">Use this 10% OFF code on your next order within 3 days.</p>
      </div>
