...
export default function CouponBuilder() {
  ...
  const { couponsMarketing: selectedFromContext, setCouponsMarketing } = useAppContext();
  ...
  const handleUseSelected = () => {
    ...
    router.push('/template/create/select-template');
  };
  ...
  .filter(
    (coupon) =>
      ...
      coupon.code.toLowerCase().startsWith('mt') &&
      coupon.offerType === 'cms'
  )
  .map((coupon) => (
    <div
      key={coupon.id}
